						...
						<div class="shop-menu clearfix pull-right">
							<ul class="nav navbar-nav">
                                ...
                                ?>
                                    ...
                                    <li><a href="account.php" class="active"><i class="fa fa-user"></i> Account (Xin chao <?php echo $_SESSION['user_name']; ?>)</a></li>
				...
				<div class="col-sm-9">
					<div class="blog-post-area">
						...
						<form action="" method="POST" enctype="multipart/form-data">
							<!-- YEU CAU: co cac input nhu tren: id, title, price va image -->
							<input type="text" name="id" placeholder="Product ID (Nhap so)" required/>
							<input type="text" name="title" placeholder="Product Title" required/>
							<input type="text" name="price" placeholder="Product Price" required/>
							<input type="file" name="image" required style="margin-bottom:10px;"/>
							<button type="submit" name="btn_add_product" class="btn btn-default">Add Product</button>
						</form>
					</div>
					</div>
				</div>

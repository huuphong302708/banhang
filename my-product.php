...
<head>
    ...
    <title>My Products | E-Shopper</title>
			...
			<div class="row">
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="my-product.php" style="color:#FE980F;">My product</a></h4>
								</div>
							</div>
				...
				<div class="col-sm-9">
					<div class="blog-post-area">
                        ...
                        <a href="add-product.php" class="btn btn-primary" style="margin-bottom: 20px;">Add New Product</a>

...
if (isset($_POST['btn_update_product'])) {
    ...
    if (mysqli_query($con, $sql_update)) {
        $thong_bao = "Cap nhat san pham thanh cong!";
    } else {
        $errors['db'] = "Co loi xay ra khi luu database.";
    }
}

$sql_get = "SELECT * FROM product WHERE id = '$id_product' AND id_user = '$id_user'";
$result = mysqli_query($con, $sql_get);

if (mysqli_num_rows($result) > 0) {
    $product_info = mysqli_fetch_assoc($result);
    $current_title = $product_info['title'];
			...
			<div class="row">
				...
				<div class="col-sm-9">
					<div class="blog-post-area">
                        ...
                        <?php if ($thong_bao != "") echo '<span style="color:green; margin-bottom:10px; display:block;">'.$thong_bao.'</span>'; ?>

						<form action="" method="POST" enctype="multipart/form-data">
							<!-- YEU CAU: cac input hien thi thong tin cu de sua -->
							<input type="text" name="title" placeholder="Product Title" value="<?php echo $current_title; ?>" required/>
							<input type="text" name="price" placeholder="Product Price" value="<?php echo $current_price; ?>" required/>
                            
                            <label>Hinh anh hien tai:</label>
                            <div style="margin-bottom: 10px;">
                                <img src="uploads/<?php echo $current_image; ?>" width="100">
                            </div>
                            
                            <label>Chon anh khac (Bo trong neu khong muon doi):</label>
							<input type="file" name="image" style="margin-bottom:10px;"/>
                            
							<button type="submit" name="btn_update_product" class="btn btn-default">Update Product</button>
						</form>
					</div>
					</div>
				</div>
